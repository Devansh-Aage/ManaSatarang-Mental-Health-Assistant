...
const TherapistCard = ({
  ...
  return (
    <div className="border-0 rounded-lg flex flex-col bg-white items-center gap-2 mb-10 mt-10 shadow-md cursor-pointer hover:shadow-lg transition-shadow w-[240px] h-[320px]">
      <img
        src={imgPath}
        alt={name}
